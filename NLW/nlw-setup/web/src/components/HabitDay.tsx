...
export function HabitDay({ defaultCompleted = 0, amount = 0 , date }: HabitProps) { //dias clicaveis
    ...
    return (
        <Popover.Root>
            {/*QUADRADINHOS*/}
            <Popover.Trigger
                className={clsx("w-10 h-10 border-2 rounded-lg transition-colors focus:ouutline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-background",{
